...
if if_file_exist(path):
    ...
    if 'integfochi' in f:
        ...
        d = dataset[()]
        ax0.plot(chi,d,lw=2,label=r'$\int{F/\chi d\chi}$')
...
# Read the table min photon chi for xi
    ...
    if 'min_photon_chi_for_xi' in f:
        ...
        fig.tight_layout()
        fig.savefig('min_particle_chi.png')
...
# Read the table xip
    ...
    if 'xi' in f:
        ...
        im = ax0.pcolormesh(chipa,chiph,xi[:,1:],
